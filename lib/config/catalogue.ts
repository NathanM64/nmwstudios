...
export const GROUPES: readonly Groupe[] = [
  ...
  { id: 'contenu', titre: 'Contenu',
    intro: 'Vos textes et vos images. Les fournir prêts à poser est compris, et c’est le cas par défaut : ce qui suit ne sert qu’à me confier ce travail, celui qui retarde le plus souvent un projet.' },
...
export const OPTIONS: readonly Option[] = [
  ...
  { id: 'reprise', libelle: 'Je restructure vos textes existants', prix: 400, unite: 'forfait', groupe: 'contenu',
    explication: 'Coupés, réordonnés, retitrés pour la structure du site. Le fond reste le vôtre.', jours: 1 },
