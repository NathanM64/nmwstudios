...
export const STYLES: readonly Style[] = [
  {
    ...
    variables: {
      ...
      '--m-legende-taille': '0.75rem',
      '--m-chiffre-taille': '3.25rem',
      '--m-rayon': '0.125rem',
      '--m-rayon-2': '0.25rem',
      '--m-densite': '1.15',
      '--m-aplat': 'linear-gradient(135deg, #b4713c 0%, #8d5a34 46%, #5b4530 100%)',
  ...
  },
  {
    ...
    variables: {
      ...
      '--m-rayon-2': '1.125rem',
      '--m-densite': '1',
      '--m-aplat': 'linear-gradient(135deg, #4f78ea 0%, #2b3f8f 55%, #151f52 100%)',
  ...
  },
  {
    ...
    variables: {
      ...
      '--m-rayon-2': '0.375rem',
      '--m-densite': '1.1',
      '--m-aplat': 'linear-gradient(140deg, #7a5f2a 0%, #33291b 52%, #16130f 100%)',
