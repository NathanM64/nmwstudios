 ...
 *  quatrième style gratuit. Plancher de taille à 0,875 rem : sous cette valeur le texte
...
export const STYLES: readonly Style[] = [
  {
    ...
    variables: {
      ...
      '--m-titre-graisse': '400',
      '--m-corps-graisse': '400',
      '--m-titre-taille': '3.5rem',
      '--m-titre-interligne': '1.02',
      '--m-titre-suivi': '-0.015em',
      '--m-corps-taille': '1.25rem',
      '--m-sous-titre-taille': '1.25rem',
      '--m-texte-taille': '1rem',
      '--m-menu-taille': '1rem',
      '--m-legende-taille': '0.875rem',
      '--m-chiffre-taille': '4rem',
      '--m-rayon': '0.125rem',
      '--m-rayon-2': '0.25rem',
      '--m-densite': '1.15',
  ...
  },
  {
    ...
    variables: {
      ...
      '--m-titre-graisse': '600',
      '--m-corps-graisse': '400',
      '--m-titre-taille': '3.25rem',
      '--m-titre-interligne': '1.06',
      '--m-titre-suivi': '-0.03em',
      '--m-corps-taille': '1.25rem',
      '--m-sous-titre-taille': '1.1875rem',
      '--m-texte-taille': '1rem',
      '--m-menu-taille': '1rem',
      '--m-legende-taille': '0.875rem',
      '--m-chiffre-taille': '3.75rem',
      '--m-rayon': '0.75rem',
      '--m-rayon-2': '1.125rem',
      '--m-densite': '1',
